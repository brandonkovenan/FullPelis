...
export const getCreditos = (peliculaid) => dispatch => {
    dispatch({
        ...
        payload: axios.get(`${urlBase}${peliculaid}/credits?api_key=${llave}&language=es`)
    })
}
...
export const getBusqueda = text => dispatch => {
    dispatch({
        ...
        payload: axios.get(`${urlBaseSearch}search/movie?query=${text}&api_key=${llave}&language=es`)
    })
}
...
export const getTrailer = (peliculaid) => dispatch => {
    dispatch({
        ...
        payload: axios.get(`${urlBase}${peliculaid}/videos?api_key=${llave}&language=es`)
